	  ...
	  session_start();
		  ...
		  if(!isset($_SESSION['email'])){
		    ...
		    $order_id = $_GET['order_id'];
		     ...
		     $query1 = "DELETE from `order_book` WHERE order_id ='$order_id'";
                               if(mysqli_query($connection, $query1)){
                               $_SESSION['msg'] = "Your Order has been cancelled successfully.";
                               }else{
...
<head>
     <title>Open Order | BitsPay </title>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Trade </a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="#!">Open Order</a>
                                        </li>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
	                                     ...
	                                     <?php  unset($_SESSION["error"]);    }      ?>
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="order-table" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                	...
                                                                	$sql ="Select * from order_book where email = '$email'  ";
						                                ...
						                                while($row = $result->fetch_assoc()) {
						                                 ?>
					                                             ...
					                                             <td><?php echo $row["coin"];  ?></td>
					                                              ...
					                                              <td><a id="<?php echo $row["order_id"]; ?>" onclick="onClick(this)" data-toggle="modal" data-target="#cancel_order" >Cancel</a></td>
		                                                                </tr>
		                                                             <?php  }
		                        				 }
                                                                ?>
                                           ...
                                           <div class="modal fade" id="cancel_order" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content w3-center">
                                                    <div class="modal-body">
                                                    <h2> <i class="icon feather icon-info f-30 text-c-green w3-large" style="font-size: 20px"></i> Are you sure that you want to canel selected order?</h2>
                                                    </div>
                                                      <form action="#" action="POST">
                                             		  <input type="hidden" id="msg" name="order_id">
...
function onClick(element) {
 ...
 console.log(order_id);
  document.getElementById("msg").value = order_id;
