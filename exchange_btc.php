...
<body>
    ...
    <section>
        ...
        <div class="limiter">
              <h1 class="w3-center" style="color: #3ff999">Bitcoin Market     </h1>
              <div class="container">
                           <div class="dropdown--pills">
            <div class="dropdown">
                <button style="background-color: #33f999; color: #fff" class="btn  dropdown-toggle input-lg" type="button" data-toggle="dropdown" id="currency-btn">BTC Market                   <span class="caret"></span>
                </button>
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-body js-pscroll">
                        ...
                        ?>          <tr class="row100 body">
									...
									<td class="cell100 column1"><a style="color: #8c8c8c" href="/historical_price?bsyn=<?php echo $symbol; ?>"> <?php echo $symbol; ?>/BTC </a></td>
 ...
 {
      $("#result").load("crypto_price_btc");// a function which will load data from other file after x seconds
  }
